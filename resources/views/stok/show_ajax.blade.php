            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            <th class="text-center col-3">ID Stok :</th>
                            <td class="col-9">{{ $stok->stok_id }}</td>
                        </tr>
                        <tr>
                            <th class="text-center col-3">Tanggal Stok :</th>
                            <td class="col-9">{{ $stok->stok_tanggal }}</td>
                        </tr>
                        <tr>
                            <th class="text-center col-3">Nama Supplier :</th>
                        ...
                        <tr>
                            <th class="text-center col-3">Jumlah Stok :</th>
