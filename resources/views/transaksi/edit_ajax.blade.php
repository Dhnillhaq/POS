...
@else
    <form action="{{ url('/transaksi/'.$penjualan->penjualan_id . '/update_ajax') }}" method="POST" id="form-edit">
        @csrf
        @method('PUT')
        <div id="modal-master" class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="form-group">
                        ...
                        <select name="user_id" id="user_id" class="form-control" required>
                            ...
                            @foreach ($user as $k)
                                <option value="{{ $k->user_id }}" {{ $penjualan->user_id == $k->user_id ? 'selected' : '' }}>{{ $k->nama }}</option>
                            @endforeach
                        </select>
