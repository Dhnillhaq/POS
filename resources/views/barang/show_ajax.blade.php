            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <table class="table table-sm table-bordered table-striped">
                        <tr>
                            <th class="text-center col-3">Kode Barang :</th>
                        ...
                        <tr>
                            <th class="text-center col-3">Harga Beli :</th>
                            <td class="col-9">{{ $barang->harga_beli }}</td>
                        </tr>
                        <tr>
                            <th class="text-center col-3">Harga Jual :</th>
                            <td class="col-9">{{ $barang->harga_jual }}</td>
                        </tr>
                        <tr>
                            <th class="text-center col-3">Kategori Barang :</th>
