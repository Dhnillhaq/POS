...
class SupplierController extends Controller
{
    ...
    public function list(Request $request)
    {
        ...
        return DataTables::of($suppliers)
            ...
            ->addColumn('aksi', function ($supplier) { // menambahkan kolom aksi
                $btn = '<a href="' . url('/supplier/' . $supplier->supplier_id) . '" class="btn btn-info btn-sm mr-1">Detail</a>';
    ...
    {
        $request->validate([
            // suppliername harus diisi, berupa string, minimal 3 karakter,
            // dan bernilai unik di tabel m_supplier kolom suppliername kecuali untuk supplier dengan id yang sedang diedit
